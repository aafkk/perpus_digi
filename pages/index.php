    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            ...
            <li class="nav-item mt-3">
                    <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Laman</h6>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item" <?= ($level == 'petugas' ? 'hidden' : '') ?>>
                    <a class="nav-link <?= ($page == 'daftarbuku' ? 'active' : '') ?> " href="?page=daftarbuku">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= ($page == 'historypeminjaman' ? 'active' : '') ?> " href="?page=historypeminjaman">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                ?>
                <li class="nav-item">
                    <a class="nav-link <?= ($page == 'kategoribuku' ? 'active' : '') ?> " href="?page=kategoribuku">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <a class="btn bg-gradient-primary mt-8 w-90" href="?page=peminjaman" <?= ($level == 'anggota' ? 'hidden' : '') ?>>Peminjaman Buku</a>
               
                 <?php 
                if ($level == 'anggota' || $level == 'admin') {
                ?>
        <a class="btn bg-gradient-primary mt-2 w-90" href="?page=pengembalian">Pengembalian Buku</a>
        <?php
                }
                ?>
        </div>
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page"><?= ucwords(preg_replace('/_/', '', $page)) ?></li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0"><?= ucwords(preg_replace('/_/', '', $page)) ?> <?= $level ?></h6>
                </nav>
